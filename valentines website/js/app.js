...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "Ayusin ang desisyon sa buhay!🤨";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "Wrong choice yan!🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "Iiyak ako dito sige ka😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
    ...
    text.innerHTML = "Payag kana pleaseee🥺😘";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "YEHEEEEEYYY!! LETS GOOOOO😘";
  yes.innerHTML = '<a href="https://www.instagram.com/loop.codes/">Plan for our date</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
